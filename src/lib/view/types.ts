...
export interface ChordChip { name: string; roman: string; notes: string; fnColor: string; border: string; bg: string; shadow: string; ch: Chord; newKey?: boolean; outside?: boolean; rest?: boolean }
