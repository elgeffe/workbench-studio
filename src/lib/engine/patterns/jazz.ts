...
export const JAZZ_PATTERNS: DrumTemplate[] = [
  ...
  // ----------------------------------------------------------- soul-jazz ----
  {
    ...
    layers: [
      ...
      { name: 'Tambourine', why: 'Off-beat tambourine is the one soul ingredient the jazz rhythm section borrowed wholesale.', add: [{ v: 'shaker', on: [2, 6, 10, 14] }] },
  ...
  },
  {
    ...
    layers: [
      ...
      { name: 'Tambourine on the beats', why: 'Tambourine on the quarters rather than the off-beats — a congregation, not a Motown session.', add: [{ v: 'shaker', on: [0, 4, 8, 12] }] },
  ...
  // ----------------------------------------------------------- jazz-funk ----
  {
    ...
    layers: [
      ...
      { name: 'Tambourine', why: 'Off-beat tambourine lifts the whole loop. Add percussion before you add drums — that is the crossover rule.', add: [{ v: 'shaker', on: [2, 6, 10, 14] }] },
  ...
  },
  {
    ...
    layers: [
      ...
      { name: 'Tambourine on 2 & 4', why: 'Tambourine doubling the backbeat rather than the off-beats widens it without adding volume.', add: [{ v: 'shaker', on: [4, 12] }] },
