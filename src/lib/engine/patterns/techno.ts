...
export const TECHNO_PATTERNS: DrumTemplate[] = [
  ...
  },
  {
    ...
    layers: [
      ...
      { name: 'Cowbell figure', why: 'Rim/cowbell on the “a of 1” and the “e of 4” — the small melodic percussion that made Detroit records feel human.', add: [{ v: 'cowbell', on: [3, 13] }] },
...

  {
    ...
    layers: [
      ...
      { name: 'Metallic perc', why: 'A rim or cowbell on 2 & 4 replaces the clap. Hard-groove techno rarely has a real backbeat sound.', add: [{ v: 'cowbell', on: [4, 12], acc: [4, 12] }] },
  ...
  },
  {
    ...
    layers: [
      ...
      { name: 'Shaker carpet', why: 'Quiet 16th shakers on the off-beats give continuous motion without the aggression of a hat pattern.', add: [{ v: 'shaker', on: [1, 3, 5, 7, 9, 11, 13, 15] }] },
  ...
  },
  {
    ...
    layers: [
      ...
      { name: 'Rolling bass', why: 'The sub bass answers on every off-beat 8th. Kick-bass-kick-bass at this speed becomes one continuous engine.', add: [{ v: 'sub', on: [2, 6, 10, 14], acc: [2, 6, 10, 14] }] },
